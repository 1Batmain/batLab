...
impl LayerType for ConvolutionType {
    ...
    fn get_back_buffers_specs(&self) -> Vec<(String, BufferSpec)> {
        ...
        vec![
            ("fwd_input".to_string(), read_storage(self.dim_input.bytes_size())),
            ...
            ("grad_output".to_string(), read_storage(self.dim_output.bytes_size())),
            ("grad_input".to_string(), write_storage(self.dim_input.bytes_size())),
            ("grad_weights".to_string(), write_storage(self.kernel_bytes())),
